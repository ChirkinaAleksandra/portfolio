...
В третьей части работы показан опыт составления запросов с помощью **SoapUI**<br><br>
...
## Часть 4. Составление запросов для мониторинга HTTP/HTTPS посредством Fiddler
В следующей части работы можно увидеть запросы, созданные с помощью **Fiddler**<br><br>
